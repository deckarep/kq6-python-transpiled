...
class LBRoom(LabRoom):
	...
	def initPseudoRoom(param1 = None):
		...
		if (global5 contains: (ScriptID 30 12)):
			((ScriptID 30 12) dispose:)
		#endif
		if (global5 contains: (ScriptID 30 13)):
		...
		if (((ScriptID 30 0) holeCoords:) == ((ScriptID 30 0) labCoords:)):
			(proc404_1)
		#endif
	#end:method
	...
	def init():
		...
		if (global12 == 411):
			...
			(= temp0
				(self calcRoom: (0 - global12) ((ScriptID 30 0) prevEdgeHit:))
			)
		#endif
		(self initPseudoRoom: temp0 ((ScriptID 30 0) prevEdgeHit:))
	#end:method
	...
	def newRoom(param1 = None):
		...
		if 
			...
			(self initPseudoRoom: param1 ((ScriptID 30 0) prevEdgeHit:))
		#endif
	#end:method
