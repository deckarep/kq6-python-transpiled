...
class rm340(KQ6Room):
	...
	def init():
		...
		if (proc913_0 1):
			...
			local2 = 20
		#endif
		(global5 add: theDoor labRock rockStep berries eachElementDo: #init)
		(global102 number: 340 setLoop: -1 play:)
		(rockStep addToPic: dispose:)
		(global0 actions: egoDoVerb init:)
		(cond
			case (global12 == 390):
				(global2 setScript: crawlOutOfCave)
			#end:case
			case (global12 == 405):
				(global1 handsOff:)
	...
	def cue():
		...
		(cond
			case ((rSacred geniePresent:) == 1):
				(global91 say: 3 1 21 1)
			#end:case
			case ((rSacred marePresent:) == 1):
				(global91 say: 3 1 22 1)
			#end:case
		)
	#end:method
		...
		(return
			match param1
				...
				case 2:
					(cond
						case ((rSacred geniePresent:) == 1):
							(global91 say: 3 2 21 1)
						#end:case
						case ((rSacred marePresent:) == 1):
							(global91 say: 3 2 22 1)
						#end:case
						else:
							(global91 say: 3 2 24 1)
						#end:else
					)
					1
				#end:case
	...
	def doit():
		...
		(cond
			...
			#end:case
			case ((global0 onControl: 1) == 1024):
				(global102 fade: 0 10 10)
				(global2 setScript: stepDown)
			#end:case
...
class labRock(Actor):
	...
	def doVerb(param1 = None):
		...
		match param1
			case 1:
				(global91 say: 5 1 local2 1)
			#end:case
			case 5:
				(global91 say: 5 5 local2 1)
			#end:case
			case 2:
				(super doVerb: param1 &rest)
			#end:case
			else:
				(global91 say: 5 0 local2 1)
			#end:else
		#end:match
	#end:method
		...
		match param1
			...
			case 5:
				if ((rSacred geniePresent:) == 1):
					(global91 say: 9 5 21 0)
				else:
					(global91 say: 9 5 27 1)
				#endif
			#end:case
			else:
				(super doVerb: param1 &rest)
...
class cave(Feature):
	...
	def doVerb(param1 = None):
		...
		if (param1 == 5):
			if ((rSacred geniePresent:) == 1):
				(global91 say: 7 5 21 1)
			else:
				(global2 setScript: crawlIntoCave)
			#endif
		else:
			(super doVerb: param1 &rest)
		#endif
	...
	def changeState(param1 = None):
		...
		match state = param1
			case 0:
				(global1 handsOff:)
				if (global12 == 320):
					(global104 number: 341 setLoop: -1 play:)
				#endif
				(global0
					view: 3011
					setLoop: 6
...
class crawlOutOfCave(Script):
	...
	def changeState(param1 = None):
		...
		match state = param1
			...
			#end:case
			case 1:
				(global0 setLoop: 5 cel: 0 setCycle: End self)
			#end:case
			case 2:
				(global1 handsOn:)
				(global0
					posn: ((global0 x:) - 12) ((global0 y:) + 3)
					reset: 5
					setScale: Scaler 100 5 105 65
				)
				(self dispose:)
...
class crawlIntoCave(Script):
	...
	def changeState(param1 = None):
		...
		match state = param1
			case 0:
				(global1 handsOff:)
				(global0 setMotion: PolyPath 283 121 self)
			#end:case
			case 1:
				cycles = 6
			#end:case
...
class goToLair(Script):
	...
	def changeState(param1 = None):
		...
		match state = param1
			case 0:
				(global1 handsOff:)
				(global0 setMotion: PolyPath 35 140 self)
			#end:case
			case 1:
...
class tryDoor(Script):
	...
	def changeState(param1 = None):
		...
		match state = param1
			case 0:
				(global1 handsOff:)
				(global0 setMotion: PolyPath 127 118 self)
			#end:case
			case 1:
				(global0 setMotion: PolyPath 127 113 self)
			#end:case
			case 2:
				(global0
					view: 361
			...
			#end:case
			case 4:
				(global0 reset: 7 posn: 127 113)
				ticks = 18
			#end:case
			case 5:
				(global91 say: 4 5 20 1 self)
			#end:case
			case 6:
				(global91 say: 4 5 20 2 self)
			#end:case
			case 7:
				(global1 handsOn:)
				(self dispose:)
...
class stepDown(Script):
	...
	def changeState(param1 = None):
		...
		match state = param1
			...
			#end:case
			case 1:
				(global0 view: 301 setLoop: 8 cel: 6 normal: 0 posn: 152 170)
				cycles = 4
			#end:case
			case 2:
				(global0 cel: 0 normal: 0 posn: 168 177)
				cycles = 4
			#end:case
			case 3:
				(global0 cel: 5 normal: 0 posn: 151 170)
				cycles = 4
			#end:case
			case 4:
				(global0 cel: 2 normal: 0 posn: 165 178)
				cycles = 4
			#end:case
			case 5:
				(global0
			...
			#end:case
			case 6:
				(global0 cel: 0 normal: 0 posn: 198 197 setCycle: End self)
			#end:case
			case 7:
				(global0 cel: 0 normal: 0 posn: 218 209 setCycle: End self)
			#end:case
			case 8:
				(global0 cel: 0 normal: 0 posn: 239 220 setCycle: End self)
			#end:case
			case 9:
				(global0 y: 280)
				cycles = 4
		...
		match state = param1
			case 0:
				...
				if ((rSacred geniePresent:) == 1):
					...
					local0 = 27
				#endif
				(global91 say: 12 5 local0 1 self)
			#end:case
			case 1:
				(global0 setMotion: PolyPath 271 118 self)
			#end:case
			case 2:
				(global0
					view: 331
			...
			#end:case
			case 3:
				(global91 say: 12 5 local0 2 self)
			#end:case
			case 4:
				(global91 say: 12 5 local0 3 self)
			#end:case
			case 5:
				if ((rSacred geniePresent:) == 1):
					(proc341_3)
...
class dieHard(Script):
	...
	def changeState(param1 = None):
		...
		match state = param1
			case 0:
				temp1 = 0
				(global91 say: 3 3 17 1 self 340)
			#end:case
			case 1:
				(global105 number: 305 setLoop: 1 play:)
				(global0
					setLoop: 2
					normal: 0
					cycleSpeed: 1
			...
			#end:case
			case 2:
				(global105 number: 306 setLoop: 1 play: self)
				(global2 walkOffEdge: 1)
				(global0
					setLoop: 2
					setStep: -1 15
					setMotion: MoveTo (global0 x:) 300 self
				)
			#end:case
			case 3: 0#end:case
			case 4:
