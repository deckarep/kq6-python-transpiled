...
class cassimaHasDagger(Script):
	...
	def changeState(param1 = None, *rest):
		...
		match state = param1
			...
			#end:case
			case 5:
				(global103 number: 754 setLoop: 1 play:)
				(global0 cel: 3)
				ticks = 3
			#end:case
			case 6:
			...
			case 28:
				...
				(global103 number: 751 setLoop: 1 play:)
				cycles = 3
			#end:case
			case 29:
			...
			#end:case
			case 30:
				(global0 setLoop: 1 cel: 0 setCycle: CT 7 1 self)
			#end:case
			case 31:
				(global0 setCycle: End self)
			#end:case
			...
			#end:case
			case 40:
				(global0 setMotion: 0 setCycle: 0)
				(global69 enable: 6)
				(global2 newRoom: 180)
			#end:case
		#end:match
	...
	def changeState(param1 = None, *rest):
		...
		match state = param1
			...
			case 1:
				(global1 handsOff:)
				if (not register):
					(global91 say: 6 23 16 1 self)
				else:
					cycles = 2
				#endif
			#end:case
			case 1:
				(global0 view: 755 posn: 151 154 setLoop: 0 cel: 6)
				cycles = 8
			#end:case
			case 2:
				(global0 cel: 5)
			...
			#end:case
			case 9:
				(global0 setLoop: 1 cel: 0 setCycle: CT 6 1 self)
			#end:case
			case 10:
				(global103 number: 0 stop:)
				(global103 number: 652 setLoop: 1 play:)
